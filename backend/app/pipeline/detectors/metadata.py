    ...
    def execute(
        ...
        *,
        ...
        if make_lower and model_lower:
            ...
            confidence = 0.95
            evidence = [
                f"Valid camera metadata present: {metadata_dict['Camera']}."
            ]
            ...
            confidence = 0.90
            evidence = [
                f"Software metadata indicates editing pipeline: {software}."
            ]
            indicators.append(
                IndicatorResult(
        ...
        elif "artificial intelligence" in image_desc_lower or "generated by ai" in image_desc_lower:
            # 🔴 AI provenance/keywords detected
            score = 0.85
            confidence = 0.95
            evidence = [
                f"AI keyword found in image description: '{image_desc}'."
            ]
            indicators.append(
                IndicatorResult(
                    type=IndicatorType.METADATA,
            ...
            confidence = 0.80
            evidence = [
                "Metadata lacks standard camera markers but shows no signs of editing software or AI provenance."
            ]
