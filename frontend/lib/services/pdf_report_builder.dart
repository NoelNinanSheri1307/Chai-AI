        ...
        build: (_) => pw.Column(
          ...
          children: [
            ...
            if (prov != null) ...[
              ...
              _kv('Final Classification', prov.finalClassification.label),
              _kv('Final Confidence',
                  '${(prov.finalConfidence * 100).round()}%'),
              ...
              if (prov.sightengineAiProbability != null)
                _kv('Sightengine AI Probability',
                    '${(prov.sightengineAiProbability! * 100).toStringAsFixed(1)}%'),
              _kv('Chai Forensic Role', 'Assisting Sightengine Verification'),
              _kv('Chai Forensic Telemetry', 'Active (7 signals)'),
              _kv('Chai Edit Score',
